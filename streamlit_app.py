        ...
        if st.button("Analyser les comptes rendus avec l'IA"):
            ...
            if 'compte_rendu' not in df.columns:
                ...
                for index, row in df.iterrows():
                    ...
                    prompt = f"Le mot étude doit être remplacé par tutorat et le mot Parkours est bien écrit de cette manière car c'est le nom de notre marque. Un bon compte rendu doit être clair, structuré et rédigé dans un registre soutenu. Voici les principales caractéristiques à prendre en compte pour la rédaction : Langue : Le compte rendu ne doit pas être rédigé à la première personne du singulier. Utiliser un langage respectueux et soutenu, en évitant les termes familiers ou vagues. Il est important d'être précis tout en restant motivant. Style : Chaque compte rendu doit commencer par une observation positive concernant les efforts ou les qualités de l'élève. Il est nécessaire d'identifier les progrès faits au cours de la période concernée, tout en soulignant les points sur lesquels l'élève peut encore s'améliorer. Ces points d'amélioration doivent être formulés de manière constructive, en proposant des pistes pour progresser. Syntaxe : Les phrases doivent être bien structurées, débutant par une majuscule et se terminant par une ponctuation adéquate. Le style doit être fluide, avec des transitions claires entre les différentes idées, afin de maintenir la cohérence du compte rendu. Motivation : Terminer par une phrase motivante pour encourager l'élève à poursuivre ses efforts et à maintenir la régularité dans son engagement au tutorat. Spécificité : Chaque commentaire doit être spécifique, mentionnant des aspects concrets du travail ou du comportement de l'élève, par exemple : 'Tu as fait preuve d'une bonne attitude face aux difficultés en posant régulièrement des questions pertinentes.' Plutôt que des termes généraux, utiliser des exemples qui montrent clairement les actions positives. Exemple : Observation positive : 'Tu as su montrer un véritable engagement dans ton travail personnel.' Améliorations suggérées : 'Pour continuer à progresser, tu devrais essayer de maintenir une concentration constante et de t’éloigner des distractions.' Conclusion motivante : 'Continue sur cette voie, tes efforts porteront leurs fruits.' Attention ce ne sont que des exemples à ne pas forcement reproduire sur chaque ligne. :\n\n{compte_rendu}"
